...
ray.init(address="ray://192.168.178.157:6379")

# Definieer een remote functie om de taak over de workers te verdelen
@ray.remote
...
# Nu kan je de rest van de app zoals eerder gebruiken
